...
export const NODE_ERROR = {
  ...
  CANNOT_DELETE_NODE_WITH_CHILDREN: 'Delete all child nodes before deleting this node',
  CANNOT_DELETE_ROOT_NODE: 'Root node cannot be deleted',
  MEMBER_ORDER_ALREADY_EXISTS: 'Member order already exists among sibling nodes',
