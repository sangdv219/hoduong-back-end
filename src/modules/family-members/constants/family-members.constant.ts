export const FAMILY_MEMBERS_ERROR = {
  ...
  USER_ALREADY_HAS_NODE: 'User already belongs to a family members',
  ...
  COUPLE_USER_ALREADY_HAS_NODE: 'Spouse user already belongs to a family members',
};
